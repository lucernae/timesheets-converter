...
class TestSageOne(unittest.TestCase):
    ...
    def test_load_csv(self):
        ...
        ts.load_csv(
            data_path('test/timesheets-sageone.csv'))
    ...
    def test_dump_csv(self):
        ...
        ts.dump_csv(
            data_path('test/dumped-sageone.csv'))
...
class TestHarvest(unittest.TestCase):
    ...
    def test_load_csv(self):
        ...
        ts.load_csv(
            data_path('test/timesheets-harvest.csv'))
    ...
    def test_dump_csv(self):
        ...
        ts.dump_csv(
            data_path('test/dumped-harvest.csv'),
            one_line=True)
        self.assertTrue(os.path.exists(
            data_path('test/dumped-harvest.csv')))
    ...
    def test_convert_to_sageone(self):
        ...
        ts.dump_csv(
            data_path('test/dumped-harvest-sageone.csv'),
...
class TestToggl(unittest.TestCase):
    ...
    def test_load_csv(self):
        ...
        ts.load_csv(
            data_path('test/timesheets-toggl.csv'))
    ...
    def test_dump_csv(self):
        ...
        ts.dump_csv(
            data_path('test/dumped-toggl.csv'),
            aggregate=True)
        self.assertTrue(os.path.exists(
            data_path('test/dumped-toggl.csv')))
    ...
    def test_convert_to_sageone(self):
        ...
        ts.dump_csv(
            data_path('test/dumped-toggl-sageone.csv'),
            target_type=SageOneTimeRecord)
        self.assertTrue(os.path.exists(
            data_path('test/dumped-toggl-sageone.csv')))
...
class TestTogglTags(unittest.TestCase):
    ...
    def test_dump_csv(self):
        ...
        ts.dump_csv(
            data_path('test/dumped-toggl-tags.csv'),
            aggregate=True)
        self.assertTrue(os.path.exists(
            data_path('test/dumped-toggl-tags.csv')))
    ...
    def test_convert_to_sageone(self):
        ...
        ts.dump_csv(
            data_path('test/dumped-toggl-tags-sageone.csv'),
            target_type=SageOneTimeRecord)
        self.assertTrue(os.path.exists(
            data_path('test/dumped-toggl-tags-sageone.csv')))
